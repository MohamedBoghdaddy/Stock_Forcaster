...
const Settings = () => {
  ...
  return (
    <div className="settings-container">
      ...
      <h3 className="mt-5">Investment Preferences</h3>
      {dashboardState.survey ? (
        <Table striped bordered hover>
          <tbody>
            <tr>
              <td>Risk Tolerance</td>
              <td>{dashboardState.survey.riskTolerance}</td>
            </tr>
            <tr>
              <td>Financial Goals</td>
              <td>{dashboardState.survey.financialGoals}</td>
            </tr>
            <tr>
              <td>Lifestyle</td>
              <td>{dashboardState.survey.lifestyle}</td>
            </tr>
          </tbody>
        </Table>
      ) : (
